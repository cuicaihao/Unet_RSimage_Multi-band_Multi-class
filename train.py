...
'''
# #  训练数据图像路径
# train_image_path = "Data/GISTIF/Processed/MUL"
# #  训练数据标签路径
# train_label_path = "Data/GISTIF/Processed/MASK"

#  训练数据图像路径
train_image_path = "Data/Aerial/RGB"
#  训练数据标签路径
train_label_path = "Data/Aerial/GT"


#  验证数据图像路径
validation_image_path = train_image_path
#  验证数据标签路径
validation_label_path = train_label_path
